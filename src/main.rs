...
use crate::{
    ...
    routes::{
        draft_route::draft_routes, draft_task_route::draft_task_routes, home::home_routes,
        officer_route::auth_routes, published_doc_route::published_doc_routes,
        review_task_route::review_task_routes,
    },
};
use actix_cors::Cors;
...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            .configure(review_task_routes)
            .configure(draft_task_routes)
    })
    .workers(2)
